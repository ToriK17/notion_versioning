...
[ETL = Extract → Transform → Load](https://www.notion.so/ETL-Extract-Transform-Load-1fa62d960d7f80b79380f014c8324d5f?pvs=21)

### 31. DNS and DNS Query

Domain Name System service is something that takes a human readable name like [`google.com`](http://google.com) and translates it to a machine readable IP address. It’s how we find anything online.

### 32. The whole HTTP request cycle

[HTTP Request Cycle](https://www.notion.so/HTTP-Request-Cycle-20062d960d7f804cac9fd91b4e1796ee?pvs=21)

### 33. Low Level Systems

[Low-Level Systems = The Bare Metal Layer (almost)](https://www.notion.so/Low-Level-Systems-The-Bare-Metal-Layer-almost-21562d960d7f80f182c3f92dc78db503?pvs=21)

### 34. PATH – The Shell’s Treasure Map

`$PATH` is an environment variable. It's a list of directories your shell looks through *in order* when you try to run a command. You type `ls`, your shell goes, “Where’s the `ls` binary hiding?” Then it rummages through folders listed in `$PATH` until it finds `/bin/ls` or `/usr/bin/ls`.

**Think of `$PATH` like your fridge, pantry, glovebox, and laundry hamper.** The system checks each one in order until it finds what you asked for. If it doesn't find it? "Command not found." Because it's not psychic.

**Note:** PATH is not a magic spell. You have to put things in the path to summon them. It won't run unless `thing-you-seek` is actually a file and you’ve told PATH where it is so it knows where to look.
...
[Tactics](https://www.notion.so/Tactics-24262d960d7f8002a57affd7932c254f?pvs=21)

### 36. Rails Front End

[Hotwire and ROR Front-end](https://www.notion.so/Hotwire-and-ROR-Front-end-2a762d960d7f8005aeb3e90e29b5e764?pvs=21)

### 37. Personal Assistant AI

[Open Claw Agent in a VM](https://www.notion.so/Open-Claw-Agent-in-a-VM-30b62d960d7f800180e2cced5aa91bfc?pvs=21)